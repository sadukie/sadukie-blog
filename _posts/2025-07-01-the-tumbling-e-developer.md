...
tags: careers
featuredImage: /assets/images/tumbling-e-developer/tumbling-e-oops.jpg
---
...
In my post [Why Engineers Need More Than One Road](https://sadukie.com/2025/06/14/why-engineers-need-more-than-one-road.html), I mentioned the T-shaped developer. I also mentioned that I'm not really one of those.

## The Grown Up T-Shaped Developer

Earlier in my career, I would have been seen as T-shaped developer. The horizontal part of the T is the breadth - seen in my wearing of many hats early on. The vertical part of the T could be seen in the scripting knowledge I had - between Perl scripting, bash scripts, and PowerShell scripts, I did a lot of scripting early on. In 2011, I [co-authored a book on PowerShell](https://www.wiley.com/en-us/Automating+Microsoft+Windows+Server+2008+R2+with+Windows+PowerShell+2.0-p-9781118013861) - so calling the vertical part of my T at that point as scripting isn't off brand.

![Automating Microsoft Windows Server 2008 R2 Administration with Windows PowerShell 2.0](/assets/images/tumbling-e-developer/ps-book.png)
...
This got me thinking - what is that really called? "Sideways E" doesn't feel like it's the right term. So I did some searching and found it - [the Tumbling E chart](https://en.wikipedia.org/wiki/E_chart)!
...
![Tumbling E, pointed downwards](/assets/images/tumbling-e-developer/tumbling-e.png)

What does that look like for me?

![Tumbling E facing downwards with the labels of "scripting", "auth(N/Z)", and "user experience" on its legs](/assets/images/tumbling-e-developer/tumbling-e-oops.jpg)
