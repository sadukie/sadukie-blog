...
Now, as a woman who's been in this field forever and is used to the numbers being skewed, I would expect this kind of behavior from those conferences who struggle with diversity. There are still plenty of conference organizers that struggle in that realm, and there's no excuse for it. If you're one of those who isn't sure how to get a better line-up, reach out to me over on [LinkedIn](https://linkedin.com/in/sadukie)! I can hook you up with a Slack community of tech event organizers from throughout the world who learn from each other!
...
Now I will call out a couple conferences that I've been to that have done it right - [CodeMash](https://codemash.org) and [Stir Trek](https://stirtrek.com). These conferences are about the same audience size and age as the other conference.
